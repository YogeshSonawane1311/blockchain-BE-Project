...
import submitask.SubmitInfoFrame;
import submitask.ViewAssignMaker;
...
public class SubmitViewFrame extends javax.swing.JFrame {
    ...
    public SubmitViewFrame() {
        super("SUBMITTED TASK VIEW FRAME");
        initComponents();
       ...
       ArrayList sdata= df.getAssignDetails();
        ...
        System.out.println("sdate: "+sdata);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Task ID", "Worker Name", "Submitted File Name", "Assigned Date Time", "Submitted Date time"
            }
        ));
        ...
        jScrollPane1.setBounds(300, 280, 1260, 402);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Provider Submited Task View Frame  ");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(530, 110, 800, 56);
