 ...
 * @author 2491
 */
public class WorkerViewFrame extends javax.swing.JFrame {
...
//        colModel.getColumn(1).setPreferredWidth(700);
      ...
      //  String colname[]={"ID ", "Provider Name", "Task Discription","No of Task","Task Deadline","Task Amount","Security Deposit"};
       ...
       ArrayList data= df.getAllDetails();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Task ID", "Provider Name", "Task Description", "No of Task", "Task Deadline", "Task Amount", "Security Amount"
            }
        ));
        ...
        jScrollPane1.setBounds(310, 250, 1260, 402);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel1.setText("Worker View Frame ");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(840, 130, 220, 28);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       ...
       // String name=(String) model.getValueAt(index1, index2);
        ...
        WorkerTaskInfoFrame.taskid=taskid;
        
        
        
         this.dispose();
         WorkerTaskInfoFrame plog=new WorkerTaskInfoFrame();
...
//        System.out.println("Task ID is "+taskid);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WorkerViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WorkerViewFrame().setVisible(true);
            }
        });
    }
