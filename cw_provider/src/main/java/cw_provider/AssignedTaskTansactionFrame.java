...
import submitask.ViewTransactionMaker;
import utility.Datakeeper;




public class AssignedTaskTansactionFrame extends javax.swing.JFrame {

   
   
    public AssignedTaskTansactionFrame() {
        super("ASSIGNED TASK TRANSACTIONS FRAME");
        initComponents();
        ...
        ((DefaultTableCellRenderer)jTable1.getTableHeader().getDefaultRenderer())
         ...
         TableColumnModel colModel = jTable1.getColumnModel();
          int rowheight=40; 
           ...
           ViewTransactionMaker df=new ViewTransactionMaker();
       ArrayList sdata= df.getAssignDetails(Datakeeper.uname);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Task ID", "Provider Name ", "Worker Name ", "Assigned File Name", "Submitted File  Name", "Contract Key", "AssignedTime", "Submitted Time ", "Reward ", "Penalty ", "Status"
            }
        ));
        ...
        jScrollPane1.setBounds(300, 250, 1260, 402);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Provider Assigned Task Transactions ");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(540, 110, 790, 56);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssignedTaskTansactionFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AssignedTaskTansactionFrame().setVisible(true);
            }
        });
    }
