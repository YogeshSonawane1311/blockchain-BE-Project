...
import db.ViewTransactionMaker;
...
//        colModel.getColumn(1).setPreferredWidth(700);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Task ID", "Provider Name ", "Worker Name ", "Assign File Name", "Submit File  Name", "Contract Key", "Assign Time", "Submit Time ", "Reward ", "Penalty ", "Status"
            }
        ));
        ...
        jScrollPane1.setBounds(320, 240, 1260, 402);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel1.setText("Worker View Transaction ");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(830, 100, 260, 28);
